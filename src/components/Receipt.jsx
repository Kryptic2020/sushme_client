...
export default function Receipt() {
  ...
  return (
    <div className='p-5'>
      ...
      <h6 className='m-5'>{orderData && orderData.table === "Online-Takeaway" ? null:`Your order is beeing prepared adn will be delivered to Table n.${orderData && orderData.table}, please wait.`}</h6>
